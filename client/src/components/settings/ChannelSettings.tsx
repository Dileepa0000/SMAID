              ...
              <div className="space-y-3 mt-2">
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <h3 className="font-semibold text-gray-900">Manual API Credentials</h3>
                        <Badge className="text-[10px] bg-purple-100 text-purple-700 border-purple-200">Manual Entry</Badge>
                      </div>
                      <p className="text-sm text-gray-600 mb-2">
                        Enter Meta Phone Number ID, Business Account ID, App ID, and Access Token manually.
                      </p>
                      <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-500">
                        <span className="flex items-center gap-1"><Check className="w-3 h-3 text-purple-500" /> Direct Token Entry</span>
                        <span className="flex items-center gap-1"><Check className="w-3 h-3 text-purple-500" /> No Facebook SDK Required</span>
                      </div>
                    </div>
